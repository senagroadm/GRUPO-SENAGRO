...
export function CanhotoDigitalPod({
  ...
  const [canhotos, setCanhotos] = useState<any[]>([
    {
      ...
      numeroExpedicao:
        expedicoes[0]?.numeroExpedicao || 'EXP-2026-0001',
      numeroNfe: '000.124.901',
      clienteNome:
        expedicoes[0]?.clienteRazaoSocial || 'Metalúrgica Brasil S/A',
      ...
      geolocalizacao:
        '-25.4284, -49.2733 (Curitiba - Doca 02)',
      fotoCanhotoUrl:
        'https://picsum.photos/seed/canhoto1/400/250',
      assinaturaDigitalUrl:
        'https://picsum.photos/seed/signature1/300/100',
    ...
    },
    {
      ...
      numeroExpedicao:
        expedicoes[1]?.numeroExpedicao || 'EXP-2026-0002',
      ...
      geolocalizacao:
        '-22.9099, -47.0626 (Campinas - Portaria A)',
      fotoCanhotoUrl:
        'https://picsum.photos/seed/canhoto2/400/250',
      assinaturaDigitalUrl:
        'https://picsum.photos/seed/signature2/300/100',
      valorFaturaNfe: 142000.0,
      liquidacaoFinanceira: 'EM_CONCILIACAO',
      ressalvaTexto:
        'Volume 03 recebido com fita adesiva de reforço, mercadoria intacta.',
    },
  ]);

  const [modalRegistroAberto, setModalRegistroAberto] =
    useState(false);

  const [
    canhotoSelecionadoDetalhe,
    setCanhotoSelecionadoDetalhe,
  ] = useState<any | null>(null);

  const [filtroTexto, setFiltroTexto] = useState('');

  // Form State para Novo Canhoto Mobile
  const [expedicaoIdForm, setExpedicaoIdForm] = useState(
    expedicoes[0]?.id || ''
  );
  ...
  const salvarNovoPod = () => {
    const exp =
      expedicoes.find((e) => e.id === expedicaoIdForm) ||
      expedicoes[0];
    ...
    const novo = {
      ...
      numeroNfe: exp.chaveNFe
        ? exp.chaveNFe.slice(-9)
        : '000.124.903',
      ...
      geolocalizacao: `-23.5505, -46.6333 (${exp.enderecoEntrega.cidade} - Galpão Central)`,

      fotoCanhotoUrl:
        'https://picsum.photos/seed/canhoto3/400/250',

      assinaturaDigitalUrl:
        'https://picsum.photos/seed/signature3/300/100',

      valorFaturaNfe:
        exp.valorMercadorias || 50000,
    ...
    setCanhotos((current) => [novo, ...current]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Captura instantânea de comprovante de entrega (POD),
              assinatura eletrônica, coordenadas GPS e liberação
              antecipada de faturamento.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs">
          ...
          <span className="text-[10px] text-slate-500 font-semibold mt-0.5 block">
            Contra 12 dias no canhoto físico
          </span>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs">
          ...
          <span className="text-[10px] text-emerald-600 font-semibold mt-0.5 block">
            100% canhotos conciliados
          </span>
        </div>

        <div className="bg-white border border-slate-200 rounded-xl p-4 shadow-xs">
          <span className="text-[11px] font-semibold text-slate-500 uppercase block">
            Taxa de Eficácia POD
          </span>
                ...
                >
                  <td className="p-3">
                    <div className="font-bold text-slate-900">
                      {canhoto.numeroExpedicao}
                    </div>

                    <div className="text-[10px] text-slate-500">
                      NF-e: {canhoto.numeroNfe}
                    </div>
                  </td>
                  ...
                  <td className="p-3">
                    ...
                    <div className="text-[10px] text-slate-500 font-mono">
                      Doc: {canhoto.recebedorDocumento}
                    </div>
                  </td>
                  ...
                  <td className="p-3">
                    ...
                    <div
                      className="text-[10px] text-slate-500 flex items-center gap-1 truncate max-w-[200px]"
                      title={canhoto.geolocalizacao}
                    >
                  ...
                  <td className="p-3">
                    <div className="font-bold text-slate-900">
                      R${' '}
                      {canhoto.valorFaturaNfe.toLocaleString(
                        'pt-BR',
                        {
                          minimumFractionDigits: 2,
                        }
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setExpedicaoIdForm(e.target.value)
                  }
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    value={recebedorNome}
                    onChange={(e) =>
                      setRecebedorNome(e.target.value)
                    }
              ...
              <div>
                <label className="font-semibold text-slate-700 block mb-1">
                  Ressalvas ou Observações de Entrega:
                </label>
              ...
              <div className="p-3 bg-emerald-50 border border-emerald-200 rounded-xl space-y-2">
                ...
                <p className="text-[11px] text-emerald-700">
                  O aplicativo móvel vincula automaticamente o
                  carimbo de data/hora oficial e as coordenadas
                  de satélite do local da entrega.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-xl w-full p-6 space-y-4 shadow-xl border border-slate-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
                ...
                {canhotoSelecionadoDetalhe.numeroExpedicao}
              </h3>

              <button
                onClick={() =>
                  setCanhotoSelecionadoDetalhe(null)
                }
                className="text-slate-400 hover:text-slate-600"
              >
                ✕
              ...
              <div className="grid grid-cols-2 gap-3 bg-slate-50 p-3 rounded-xl">
                <div>
                  ...
                  <strong className="text-slate-900">
                    {canhotoSelecionadoDetalhe.clienteNome}
                  </strong>
                </div>
                ...
                <div>
                  ...
                  <strong className="text-slate-900">
                    {canhotoSelecionadoDetalhe.numeroNfe}
                  </strong>
                </div>
                ...
                <div>
                  ...
                  <strong className="text-slate-900">
                    {canhotoSelecionadoDetalhe.recebedorNome}{' '}
                    (Doc:{' '}
                    {
                      canhotoSelecionadoDetalhe.recebedorDocumento
                    }
                    )
                  </strong>
                </div>
                ...
                <div>
                  ...
                  <strong className="text-slate-900">
                    {canhotoSelecionadoDetalhe.dataEntrega}
                  </strong>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="border border-slate-200 rounded-lg p-2.5 space-y-1.5">
                  ...
                  <div className="h-32 bg-slate-100 rounded flex items-center justify-center text-slate-400 font-mono text-[10px] overflow-hidden">
                    <img
                      src={
                        canhotoSelecionadoDetalhe.fotoCanhotoUrl
                      }
                      alt="Canhoto"
                ...
                <div className="border border-slate-200 rounded-lg p-2.5 space-y-1.5">
                  ...
                  <div className="h-32 bg-slate-100 rounded flex items-center justify-center text-slate-400 font-mono text-[10px] overflow-hidden">
                    <img
                      src={
                        canhotoSelecionadoDetalhe.assinaturaDigitalUrl
                      }
                      alt="Assinatura"
                      className="w-full h-full object-cover"
                    />
              ...
              {canhotoSelecionadoDetalhe.ressalvaTexto && (
                <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-900">
                  <strong className="block text-[11px] mb-0.5">
                    Ressalva Registrada no Ato da Entrega:
                  </strong>
